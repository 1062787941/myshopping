		...
		<c:choose>
			...
			<div class="step step1">
				...
				<div class="total">
					...
					赠送积分: <em id="effectivePoint">${cartSession.total }</em>
					商品金额: <strong id="effectivePrice">￥${cartSession.total }元</strong>
				</div>
				<div class="bottom">
					<a href="${ pageContext.request.contextPath }/cart/clearCart.action" id="clear" class="clear">清空购物车</a>
					<a href="${ pageContext.request.contextPath }/order/saveOrder.action" id="submit" class="submit">提交订单</a>
				</div>
			</div>
			</c:when>
