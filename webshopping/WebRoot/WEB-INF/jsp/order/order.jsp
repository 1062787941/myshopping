		...
		<div class="span24">
			...
			<div class="step step1">
				...
				<table>
					...
					<c:forEach var="orderItem" items="myOrder.orderItems">
						<tr>
							<td width="60">
				...
				<div class="total">
					<em id="promotion"></em>
					商品金额: <strong id="effectivePrice">￥${ myOrder.total}元</strong>
				</div>
			<form id="orderForm" action="${ pageContext.request.contextPath }/order/payOrder.action" method="post">
				...
				<div class="span24">
					<p>
							收货地址：<input name="addr" type="text" value="${myOrder.user.addr }/>" style="width:350px" />
								<br />
							收货人&nbsp;&nbsp;&nbsp;：<input name="name" type="text" value="${myOrder.user.name }" style="width:150px" />
								<br /> 
							联系方式：<input name="phone" type="text"value="${myOrder.user.phone }" style="width:150px" />
						</p>
						<hr />
						<p>
							选择银行：<br/>
