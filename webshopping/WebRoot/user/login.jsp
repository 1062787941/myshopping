...
<div class="headerAd">
	...
	<%@ include file="menu.jsp" %>
		...
		<div class="span12">
<div class="ad">
					<img src="${pageContext.request.contextPath}/image/user/login.jpg" width="500" height="330" alt="会员登录" title="会员登录" />
</div>		</div>
...
<div class="container footer">
	...
	<div class="span24">
		<div class="copyright">Copyright © 2010-2017 网上商城 版权所有</div>
	</div>
</div>
</body></html>