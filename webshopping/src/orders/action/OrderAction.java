...
public class OrderAction {
	...
	public String saveOrder(@ModelAttribute("cartSession")Cart cartSession,
			@ModelAttribute("session_user")User existUser,ModelMap model) {
		...
		if (cart.getCartItems() == null) {
			model.addAttribute("mssage","亲!您还没有购物!");
		...
		// 设置订单关联的客户:
//		User existUser = user;
		System.out.println(existUser.getName()+"---"+existUser.getUid());
		if (existUser.getUid() == null) {
			model.addAttribute("mssage","亲!您还没有登录!");
			return "/WEB-INF/jsp/msg";
		}
